...
int main(){
    ...
    //Set all bits // Masking all bit at once
    ...
    //Reset bits at position 0, 2, 4, 6
    ...
    cout << endl;
    cout << "Checking state of each bit position (on/off)" << endl;
