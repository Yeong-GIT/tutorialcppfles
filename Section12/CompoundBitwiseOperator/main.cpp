...
int main(){
    ...
    cout << endl;
    cout << "Compound bitwise assgnment operators" << endl;

    unsigned char sandbox_var{0b00110100}; //unsigned positive number only 8 bit memory 
    ...
    //Compound AND with 0000 1100 to turn off thee 2 lowest bits
    cout << endl;
